...
class NetworkManager(manager.Manager):
    ...
    def allocate_for_instance(self, context, **kwargs):
        ...
        """
        LOG.info(trace_event.event('compute.allocate.network.instance.start',None,context,''))
        ...
        LOG.info(_LI("Allocated network: '%s' for instance"), net_info,
                 ...
                 context=context)
        LOG.info(trace_event.event('compute.allocate.network.instance.end',None,context,''))
        return net_info
    ...
    def deallocate_for_instance(self, context, **kwargs):
        ...
        LOG.info(trace_event.event('compute.deallocate.network.instance.start',None,context,''))
        ...
        LOG.info(trace_event.event('compute.deallocate.network.instance.end',None,context,''))
    ...
    def lease_fixed_ip(self, context, address):
        ...
        LOG.info(trace_event.event('compute.network.lease_fixed_ip.instance.start',None,context,'lease fix ip'))
        ...
        LOG.info(trace_event.event('compute.network.lease_fixed_ip.instance.end',None,context,'lease fix ip'))

    def release_fixed_ip(self, context, address, mac=None):
        """Called by dhcp-bridge when ip is released."""
        LOG.info(trace_event.event('compute.network.release_fixed_ip.instance.start',None,context,'release ip'))
        ...
        if not fixed_ip.allocated:
            ...
            LOG.debug('Disassociating fixed IP %s from instance.', address,
                      instance_uuid=fixed_ip.instance_uuid)
            fixed_ip.disassociate()
        LOG.info(trace_event.event('compute.network.release_fixed_ip.instance.end',None,context,'release ip'))
