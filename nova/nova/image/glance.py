...
class GlanceImageService(object):
    ...
    def download(self, context, image_id, data=None, dst_path=None):
        ...
        msg="{'event_type':'nova.image.download.start','request_id':'"+str(context.request_id)+"','vmname':''}"	
	LOG.info("lttng_trace:"+msg)
        ...
        if data is None:
            ...
            try:
                ...
                if close_file:
                    data.close()
        msg="{'event_type':'nova.image.download.end','request_id':'"+str(context.request_id)+"','vmname':''}"	
	LOG.info("lttng_trace:"+msg)
