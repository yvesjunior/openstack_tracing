...
class ComputeManager(manager.Manager):
    ...
    def _destroy_evacuated_instances(self, context):
        ...
        """
        #msg="{'event_type':'compute.evacuate.instance.start','request_id':'"+str(context.request_id)+"','vmname':'','vm_state':''}"
        ...
        for instance in evacuated:
            ...
            migration.save()
        #msg="{'event_type':'compute.evacuate.instance.end','request_id':'"+str(context.request_id)+"','vmname':'','vm_state':''}"
	    #LOG.info("lttng_trace:"+msg)
	...
	#msg="{'event_type':'compute.instance."+str(event_suffix)+"','vmname':'"+str(instance.hostname)+"','host':'"+str(instance.host)+"','vm_state':'"+str(instance.vm_state)+"','task_state':'"+str(instance.task_state)+"','power_state':'"+str(instance.power_state)+"','project_id':'"+str(instance.project_id)+"','user_id':'"+str(instance.user_id)+"','request_id':'"+str(context.request_id)+"'}"
    	#LOG.info("lttng_trace:"+msg)
        LOG.info(trace_event.event("'compute.instance."+str(event_suffix)+"'",instance,context,''))
