...
from nova.trace import trace_event
libvirt = None
...
# Step count
LIVE_MIGRATION_DOWNTIME_STEPS_MIN = 4
# Delay in seconds
LIVE_MIGRATION_DOWNTIME_DELAY_MIN = 20
...
class LibvirtDriver(driver.ComputeDriver):
	...
	#LOG.info(trace_event('libvirt.can_live_migrate_destination.start',instance,context,''))
	...
	#LOG.info(trace_event('libvirt.can_live_migrate_destination.end',instance,context,''))
	...
	#LOG.info(trace_event('libvirt.can_live_migrate_source.start',instance,context,''))
        source = CONF.host
        ...
        dest_check_data['is_shared_storage'] = (
            dest_check_data['is_shared_instance_path'])
	#LOG.info(trace_event('libvirt.can_live_migrate_source.end',instance,context,''))
	...
	#   LOG.info("lttngtest attr "+str(info.__dict__))
    ...
    def _live_migration_monitor(self, context, instance, guest,
        ...
        while True:
            ...
            if info.type == libvirt.VIR_DOMAIN_JOB_NONE:
                ...
                #----for trace purpose
		data_process=info.data_processed
    ...
    def _live_migration(self, context, instance, dest, post_method,
        ...
        time.sleep(0)
        #self.set_instance_priority(instance,"3")#test for analyse
    ...
    def _try_fetch_image(self, context, path, image_id, instance,
                         fallback_from_host=None):
        LOG.info("try_fetch_image.start")                 
        try:
            ...
            libvirt_utils.copy_image(src=path, dest=path,
                                     ...
                                     receive=True)
	LOG.info("try_fetch_image.end")

    def _fetch_instance_kernel_ramdisk(self, context, instance,
                                       fallback_from_host=None):
        """Download kernel and ramdisk for instance in instance directory."""
	LOG.info("fetch_instance.kernel_ramdisk.start")
        instance_dir = libvirt_utils.get_instance_path(instance)
            ...
            if instance.ramdisk_id:
                ...
                if not os.path.exists(ramdisk_path):
                    self._try_fetch_image(context,
                                          ...
                                          instance.ramdisk_id,
                                          instance, fallback_from_host)
	LOG.info("fetch_instance.kernel_ramdisk.end")
    ...
    def pre_live_migration(self, context, instance, block_device_info,
        ...
        LOG.info("driver.data.pre_live_migration.start")
	...
	LOG.info("driver.data.pre_live_migration.end")
        return res_data
    ...
    def _try_fetch_image_cache(self, image, fetch_func, context, filename,
                               ...
                               fallback_from_host=None):
        LOG.info("try_fetch_image_cache.start")
        try:
            ...
            image.cache(fetch_func=copy_from_host,
                        filename=filename)
	LOG.info("try_fetch_image_cache.end")
    ...
    def _create_images_and_backing(self, context, instance, instance_dir,
        ...
        """
        LOG.info("create_image_and_back.start")
        if not disk_info:
            disk_info = []
        ...
        LOG.info("create_image_and_back.end")
    ...
    def migrate_disk_and_power_off(self, context, instance, dest,
        ...
        LOG.debug("Starting migrate_disk_and_power_off",
                   instance=instance)
	LOG.info("lttng migrate_disk_and_power_off.start")
        ...
        try:
            ...
            with excutils.save_and_reraise_exception():
                self._cleanup_remote_migration(dest, inst_base,
                                               inst_base_resize,
                                               shared_storage)
	LOG.info("lttng migrate_disk_and_power_off.end")
    ...
    def set_instance_priority(self,instance,to):
    	name=str(instance.name)
	res=os.popen("pgrep "+str(instance.name)).read()
	res=os.popen("sudo ionice -c "+str(to)+ " -p "+res).read()
	print res
	print "****************************-----------------+++++++++++++++++++++++++++++++++++"
