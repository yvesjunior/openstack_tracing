...
def copy_image(src, dest, host=None, receive=False,
    ...
    :param compression: Allows to use rsync operation with or without
                        compression
    """
    LOG.info("libvirt.copy.image.start")
    if not host:
    ...
    LOG.info("libvirt.copy.image.end")
...
def write_to_file(path, contents, umask=None):
    ...
    """
    LOG.info("libvirt.utils.write_to_file.start")
    if umask:
    ...
    LOG.info("libvirt.utils.write_to_file.end")
