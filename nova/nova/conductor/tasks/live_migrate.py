...
class LiveMigrationTask(base.TaskBase):
    ...
    def _execute(self):
    	msg="{'event_type':'conductor.live_migration.start',"+"'source':'"+str(self.source)+"','destination':'"+str(self.destination)+"'}"	
	LOG.info("lttng_trace:"+msg)
        ...
        msg="{'event_type':'conductor.live_migration.end',"+"'source':'"+str(self.source)+"','destination':'"+str(self.destination)+"'}"	
	LOG.info("lttng_trace:"+msg)
